# Entrega Semana 4 — Desarrollo mediante MDD4CPS

**Lo solicitado en las diapositivas** (Semana 4, «Actividad semanal — Desarrollo
mediante MDD4CPS»). Entregables declarados y su estado:
...
| Presentación (PDF o PowerPoint) | ✅ 10 diapositivas | `../slides/semana-4/presentacion.pdf` |
...
**Instrucciones de la actividad cubiertas:**

| Instrucción (diapositiva) | Dónde se responde |
|---|---|
| Generar el PIM completando la información de diseño solicitada | `actividad-mdd4cps.md`, §1.1 |
...
**Presentación canónica:** `../slides/semana-4/presentacion.html` → `.pdf`
(plantilla institucional UFRO, la misma de las cuatro semanas).

> **Versión alternativa del mismo mazo** (conservada, no es la entrega):
> `presentacion.md` en formato Marp. Si se edita, hay que reflejar el cambio en la
> versión canónica.
